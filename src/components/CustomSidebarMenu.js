...
const CustomSidebarMenu = (props) => {
  ...
  const proileImage =
    "user-or.png?alt=media&token=f0890032-889c-42ca-8ed1-9443cad8f0f4";
  const star_filled =
    "star_filled-or.png?alt=media&token=64dcbfb2-902e-46e8-aead-311913002fc9";
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#FEF3B4" }}>
      ...
      <DrawerContentScrollView {...props}>
        ...
        <DrawerItem
          ...
          onPress={() => Linking.openURL("http://pauloamaral.com.br/")}
        />
